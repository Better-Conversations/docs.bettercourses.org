...
This is a list of links that are stable and will not change, and will redirect the user to the current correct page. For example, if we issue new flight plans or reorganise the site, https://betterconversations.foundation/l/flightplans will always take you to the current list of flight plans.
