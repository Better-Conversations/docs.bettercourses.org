...
We recommend that you attend the course before you start using these materials. If you'd like to do that, please [get in touch](mailto:hello@betterconversations.foundation) and we can connect you with expert trainers around the world who have experience working with us.
...
The course is usually delivered in English, but you might want to deliver it in another language. Again, that's fine. We've tried to explain things in a way that's easy to translate. 

The course is usually delivered over five 1-hour online modules (with an optional 6th module) across several weeks, but you might want to deliver it in a different way. 
